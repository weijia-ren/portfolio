...
- **Real-query linkage**: Because the survey was sent 2–24 hours after the search rather than during the search itself, an initial screener asked users to recall the query they had performed; only if they remembered it did they proceed to the follow-up survey. This linked each response to the specific query and grounded motivations in actual behavior rather than hypothetical scenarios.
